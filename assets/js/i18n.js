...
const COPY = {
  en: {
    ...
    "heroSlogans": [
      { "text": "Logistics, engineered for certainty.", "accent": "certainty" },
      { "text": "Global scale, human precision.", "accent": "precision" },
      { "text": "Where the world's cargo moves.", "accent": "world's cargo" },
      { "text": "One partner across every border.", "accent": "every border" },
      { "text": "Visibility from origin to door.", "accent": "Visibility" },
      { "text": "Your supply chain, mastered.", "accent": "mastered" },
      { "text": "33 branches. One standard.", "accent": "One standard" },
      { "text": "Compliance without compromise.", "accent": "without compromise" },
      { "text": "Built for global ambition.", "accent": "global ambition" },
    ...
    "network.mapHint": "Tap any city for details",
    "network.panelTime": "Local time",
    "network.panelPhone": "Phone",
    "network.setOrigin": "Set as origin",
    "network.pickDest": "Now tap a destination city",
    "network.clearRoute": "Clear",
    "network.inquireLane": "Request this lane",
    "about.history": [
    ...
    "contact.note": "We’ll get back to you as soon as possible.",
  ...
  zh: {
    ...
    "heroSlogans": [
      { "text": "物流，因确定性而生。", "accent": "确定性" },
      { "text": "全球格局，匠心精度。", "accent": "匠心精度" },
      { "text": "世界货物，在此流转。", "accent": "世界货物" },
      { "text": "跨越国界，一个伙伴。", "accent": "一个伙伴" },
      { "text": "从源头到门，全程可视。", "accent": "全程可视" },
      { "text": "您的供应链，尽在掌控。", "accent": "尽在掌控" },
      { "text": "33 家分支，同一标准。", "accent": "同一标准" },
      { "text": "合规之道，绝不妥协。", "accent": "绝不妥协" },
      { "text": "为全球化雄心而生。", "accent": "全球化雄心" },
      { "text": "长帆背书，值得托付。", "accent": "值得托付" }
    ],
    "hero.cta1": "浏览服务",
    "hero.cta2": "联系我们",
    ...
    "network.mapHint": "点击任意城市查看详情",
    "network.panelTime": "当地时间",
    "network.panelPhone": "电话",
    "network.setOrigin": "设为起运地",
    "network.pickDest": "再点一个城市作为目的地",
    "network.clearRoute": "清除",
    "network.inquireLane": "就该线路询盘",
    "about.history": [
